...
public class LevelDAO {
    ...
    public List<LevelCO> getAllLevels() {
        String sql = "select id,level,exp,energy,e_storage_size,s_storage_size,troop_size from level";
    ...
    public LevelCO get(int level) {
        String sql = "select id,level,exp,energy,s_storage_size,e_storage_size,troop_size from level where level=?";
