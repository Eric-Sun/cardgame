...
public class LevelDAO {
    ...
    public List<LevelCO> getAllLevels() {
        String sql = "select id,level,exp,energy,storage_size,troop_size from level";
    ...
    public LevelCO get(int level) {
        String sql = "select id,level,exp,energy,storage_size,troop_size from level where level=?";
